...
String.prototype.grammarPolice = function () {
  ...
  var rest = []
  var answer = []
  var newSen = this.toLowerCase().split(' ')

  for (var x = 0; x < newSen.length; x += 1) {
    upper = newSen[x].charAt(0).toUpperCase()
    rest = newSen[x].replace(/\w/, upper)
    answer.push(rest)
  }
  return answer.join(' ')
}
